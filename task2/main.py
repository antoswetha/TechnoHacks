...
rock_player = PhotoImage(file="resources/rock.png")
rock_player_ado = rock_player.subsample(3, 3)
paper_player = PhotoImage(file="resources/paper.png")
paper_player_ado = paper_player.subsample(3, 3)
scissor_player = PhotoImage(file="resources/scissor.png")
scissor_player_ado = scissor_player.subsample(3, 3)
rock_computer = PhotoImage(file="resources/rock.png")
paper_computer = PhotoImage(file="resources/paper.png")
scissor_computer = PhotoImage(file="resources/scissor.png")
...
def MatchProcess():
    ...
    if computer_option == 1:
        computer_image.configure(image=rock_player)
        RockCom()
...
player_label.config(bg="black", fg="white", font=('Times New Roman', 12, 'bold'))
computer_label = Label(root, text="COMPUTER")
computer_label.grid(row=1, column=3)
computer_label.config(bg="black", fg="white", font=('Times New Roman', 12, 'bold'))
...
button_quit = Button(root, text="Quit", bg="black", fg="white", font=('Times New Roman', 18, 'bold'), command=ExitApplication)
